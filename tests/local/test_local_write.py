...
class TestLocalFilesystemWrite(LocalFilesystemTestBase):
    ...
    def test_adls_write_parquet_nopart_no_compression_from_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_nocompression")
        self.validate_compression(path=f"{self._base_path}/parquet/test_nocompression",
    ...
    def test_adls_write_parquet_nopart_no_compression_from_arrow_pandas(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_nocompression_pandas")
        self.validate_compression(path=f"{self._base_path}/parquet/test_nocompression_pandas",
                                  compression='UNCOMPRESSED')
    ...
    def test_adls_write_parquet_nopart_no_compression_from_arrow_recordBatches(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_nocompression_batch_reader")
        self.validate_compression(path=f"{self._base_path}/parquet/test_nocompression_batch_reader",
                                  compression='UNCOMPRESSED')
    ...
    def test_adls_write_parquet_nopart_snappy_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_snappy")
        self.validate_compression(path=f"{self._base_path}/parquet/test_snappy",
                                  compression='SNAPPY')
    ...
    def test_adls_write_parquet_nopart_gzip_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_gzip")
        self.validate_compression(path=f"{self._base_path}/parquet/test_gzip",
                                  compression='GZIP')
    ...
    def test_adls_write_parquet_nopart_brotli_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_brotli")
        self.validate_compression(path=f"{self._base_path}/parquet/test_brotli",
                                  compression='BROTLI')
    ...
    def test_adls_write_parquet_nopart_zstd_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_zstd")
        self.validate_compression(path=f"{self._base_path}/parquet/test_zstd",
                                  compression='ZSTD')
    ...
    def test_adls_write_parquet_nopart_lz4_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/parquet/test_lz4")
        self.validate_compression(path=f"{self._base_path}/parquet/test_lz4",
                                  compression='LZ4')
    ...
    def test_adls_write_deltalake_nopart_no_compression_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_nocompression")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_nocompression",
                                  compression='UNCOMPRESSED')
    ...
    def test_adls_write_deltalake_nopart_no_compression_from_arrow_pandas(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_nocompression_pandas")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_nocompression_pandas",
                                  compression='UNCOMPRESSED')
    ...
    def test_adls_write_deltalake_nopart_no_compression_from_arrow_recordBatches(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_nocompression_batch_reader")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_nocompression_batch_reader",
                                  compression='UNCOMPRESSED')
    ...
    def test_adls_write_deltalake_nopart_snappy_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_snappy")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_snappy",
                                  compression='SNAPPY')
    ...
    def test_adls_write_deltalake_nopart_gzip_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_gzip")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_gzip",
                                  compression='GZIP')
    ...
    def test_adls_write_deltalake_nopart_brotli_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_brotli")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_brotli",
                                  compression='BROTLI')
    ...
    def test_adls_write_deltalake_nopart_zstd_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_zstd")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_zstd",
                                  compression='ZSTD')
    ...
    def test_adls_write_deltalake_nopart_lz4_arrow_table(self):
        ...
        self.validate_number_of_records(path=f"{self._base_path}/deltalake/test_lz4")
        self.validate_compression(path=f"{self._base_path}/deltalake/test_lz4",
                                  compression='LZ4')
